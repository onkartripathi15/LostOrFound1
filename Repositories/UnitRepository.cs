...
namespace LostOrFound.Repositories
{
    public class UnitRepository : IUnit
    {
        ...
        public PaginatedList<Unit> GetItems(string SortProperty, SortOrder sortOrder,string SearchText="",int pageIndex=1,int pageSize=5)
        {
            ...
            {
                units = _context.Units.Where(n => n.Name.Contains(SearchText) || n.Description.Contains(SearchText) || n.Date.Contains(SearchText) )
                    .ToList();            
            }
            else
